...
- adding state to the create ticket form
- note: price input gets onBlur listener so react can format the input when clicking outside input component
...
### landing on / index should fetch data
- lesson 489 - at 1min 47sec
- `client/pages/index.js`
- should make a request from `getInitialProps()`
- what we return from getInitialProps is merged with props passed to LandingPage Component
...
<img
src='exercise_files/udemy-microservices-section22-489-listing-tickets-table.png'
alt='udemy-microservices-section22-489-listing-tickets-table.png'
width=600
/>
...
- once timer expires, then hide the button and timer and show appropriate message
- do calculation: `new Date(${expiresAt}) - new Date()` gives milliseconds till expired
- OrderShow.getInitialProps() return `{order: data}` and is accessed by `OrderShow` component
- TODO: once timer gets to 0 -> hide timer

<img
src='exercise_files/udemy-microservices-section22-494-network-request-log-after-creating-order.png'
alt='udemy-microservices-section22-494-network-request-log-after-creating-order.png'
width=600
/>
